...
- Decision logic: binary — daysWithoutSales >= 2 → PAUSAR; else ROAS >= 2 → ESCALAR; else PAUSAR. No OTIMIZAR/MONITORAR.
...
- Performance summary panel: Melhor ROAS / Pior CPA / Mais Vendas highlights + ESCALAR/PAUSAR badge counts
