...
const DECISION_TOOLTIPS: Record<string, string> = {
  ...
  ATENÇÃO: "ROAS entre 1× e 2× — margem baixa, sem gatilho de monitorar ou pausar; avalie otimizações",
...
function DecisionBadge({ label, colorClasses, size = "md" }: DecisionBadgeProps) {
  const sizeClasses =
    size === "sm"
